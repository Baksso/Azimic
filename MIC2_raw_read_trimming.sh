...
do
   ...
   java -jar /shared/software/trimmomatic-0.39/trimmomatic-0.39.jar PE -threads 12 -phred33 $R1 $R2 $R1paired $R1unpaired $R2paired $R2unpaired ILLUMINACLIP:TruSeq3-PE-2.fa:2:30:10 LEADING:30 TRAILING:20 AVGQUAL:25 MINLEN:36
done
